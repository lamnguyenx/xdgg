...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info 250 232"  # Light gray bg, dark gray text for e-ink
		"hostname 244 255"          # Gray bg, white text
		#"mode_indicator 165 0"
		#"ifstat 30 255"
		#"ifstat_sys 30 255"
		"lan_ip 250 232 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"  # Light bg, dark text
		#"vpn 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		#"wan_ip 250 232"            # REMOVED: WAN IP
		#"vcs_branch 244 232"        # REMOVED: Git branch
		#"vcs_compare 60 255"
		#"vcs_staged 64 255"
		#"vcs_modified 9 255"
		#"vcs_others 245 0"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		#"earthquake 3 0"
		"pwd 244 255"               # Gray bg, white text
		...
		"date_day 250 232"          # Light bg, dark text
		"date 250 232 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time 250 232 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
